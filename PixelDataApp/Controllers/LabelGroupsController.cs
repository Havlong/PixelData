...
namespace PixelDataApp.Controllers
{
    public class LabelGroupsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] LabelGroup labelGroup)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] LabelGroup labelGroup)
        {
            if (id != labelGroup.Id)
            {
                return NotFound();
